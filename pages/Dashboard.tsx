    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-12">
      ...
      <main className="container mx-auto px-6 py-10">
        ...
        <div className="grid gap-6">
          {/* Mock Existing Declaration */}
          <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 hover:border-[#00904E] hover:shadow-md transition-all cursor-pointer group">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#1E293B] group-hover:text-[#00904E] transition-colors">Déclaration 2023</h3>
                  <p className="text-sm text-[#64748B]">{t('dashboard.modified')} 15.03.2024</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <span className="bg-[#00904E]/10 text-[#00904E] px-3 py-1 rounded-full text-xs font-bold border border-[#00904E]/20">{t('dashboard.status_finished')}</span>
